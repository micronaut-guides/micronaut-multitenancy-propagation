...
----
include::{sourceDir}/gateway/build.gradle[tag=views]
----

Micronaut includes https://docs.micronaut.io/snapshot/api/io/micronaut/views/handlebars/HandlebarsViewsRenderer.html[HandlebarsViewsRenderer] which uses the http://jknack.github.io/handlebars.java/[Handlebars.java] project.
...
.gateway/build.gradle
----
include::{sourceDir}/gateway/build.gradle[tag=handlebars]
----
